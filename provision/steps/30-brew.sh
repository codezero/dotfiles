...
if dry; then
  ...
  as_user "eval \"\$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)\"; brew update --quiet" \
    || stale_warn "brew update failed — formulae install from the index already on the box (may be stale)"
  as_user "eval \"\$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)\"; brew bundle --file='$FILTERED'" \
