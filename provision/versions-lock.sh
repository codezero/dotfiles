#!/usr/bin/env bash
# ============================================================================
# versions-lock.sh — RECORD the versions of the packages and tools this repo
# names (not their dependencies), and REPORT
...
emit_header() {
  ...
  [ -n "$sha" ] || sha="unknown"
  printf '# versions.lock — versions of the packages and tools this repo names (not their dependencies). Generated by provision/versions-lock.sh; read by `check`.\n'
